...
class PerfumeMaker:
    ...
    def create_main_menu(self):
        ...
        free_reign_button = Button(frame, text="Free Reign", bg="lightgreen", font="Verdana 12 bold",command=lambda: self.show_frame("..."))
        free_reign_button.grid(row=1, column=0, sticky=NSEW)
        
        preset_palette_button= Button(frame, text="Preset Palette", bg="yellow", font="Verdana 12 bold",command=lambda: self.show_frame("..."))
        preset_palette_button.grid(row=1, column=1, sticky=NSEW)
